...
ax1Twin.set_ylim(bottom=0, top=400)
ax1.set_xlim(left=0, right=t_end)
ax1.set_ylabel('p-Pop. (SSA)')
ax2.set_ylabel('p-Pop. (SEG)')
ax1Twin.set_ylabel('s-Pop. (SSA)')
ax2Twin.set_ylabel('s-Pop. (SEG)')
...
##
fig.legend(bbox_to_anchor=(0.5, 0.95), loc="center", ncol=4, shadow=True, numpoints=2)
fig.tight_layout()
