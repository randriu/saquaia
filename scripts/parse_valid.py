...
import pickle
# %%
for fn in glob.glob("../sge_res/valid/valid_*.json.gz"):
    print(fn)
...
stat = {}
for fn in tqdm(glob.glob("../sge_res/valid/valid_*.json.gz")):
    #print(fn)
    d = json.load(gzip.open(fn, "rt"))
...
SSA.save("../sge_res/valid.SSA")
df_stat = pd.DataFrame(stat).T
df_stat.to_pickle("../sge_res/valid.stat.pkl.gz")
# %%
len(SSA.X)
# %%
